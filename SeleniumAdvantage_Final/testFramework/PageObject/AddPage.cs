...
namespace testFramework.PageObject
{
    public class AddPage : WebDriverAction
    {
        ...
        private readonly string firstname = "Harry";
        private readonly string lastname="Potter";
        private readonly string email = "harrypotter@gmail.com";
        private readonly string age = "17";
        private readonly string salary = "10000";
        private readonly string department = "Hogwarts";
